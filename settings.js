...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=KMsHgQZb#trToPurYpABaZ5PsPL_TDrv7fpPEH-_NuEyO9SxnFWY' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94766494699' : process.env.OWNER_NUMBER,   
